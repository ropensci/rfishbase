...
```
# A tibble: 306 x 100
   SpecCode Species SpeciesRefNo Author FBname PicPreferredName PicPreferredNam…
      <dbl> <chr>          <dbl> <chr>  <chr>  <chr>            <chr>           
 1     6210 Salmo …        59043 (Heck… Adria… Saobt_u0.jpg     <NA>            
 2     8705 Schizo…         4832 (Gray… Snowt… Scric_u1.jpg     <NA>            
 3    24454 Schizo…         4832 (Heck… Algha… <NA>             <NA>            
 4      246 Salvel…        86798 (Mitc… Brook… Safon_u4.jpg     <NA>            
 5      238 Salmo …         4779 Linna… Sea t… Satru_u2.jpg     <NA>            
 6    67602 Salmo …        99540 Turan… Antal… Sakot_m0.jpg     <NA>            
 7     2687 Oncorh…         5723 (Mill… Apach… Onapa_u0.jpg     <NA>            
 8     2687 Oncorh…         5723 (Mill… Apach… Onapa_u0.jpg     <NA>            
 9     6082 Plectr…         5222 (R<fc… Squar… Plare_u4.jpg     <NA>            
10      238 Salmo …         4779 Linna… Sea t… Satru_u2.jpg     <NA>            
# … with 296 more rows, and 93 more variables: PicPreferredNameF <chr>,
#   PicPreferredNameJ <chr>, FamCode <dbl>, Subfamily <chr>, GenCode <dbl>,
#   SubGenCode <dbl>, BodyShapeI <chr>, Source <chr>, AuthorRef <lgl>,
#   Remark <chr>, TaxIssue <dbl>, Fresh <dbl>, Brack <dbl>, Saltwater <dbl>,
#   DemersPelag <chr>, Amphibious <lgl>, AmphibiousRef <lgl>, AnaCat <chr>,
...
#   Complete <lgl>, GoogleImage <dbl>, Comments <chr>, Profile <chr>,
#   PD50 <dbl>, Emblematic <dbl>, Entered <dbl>, DateEntered <dttm>,
#   Modified <dbl>, DateModified <dttm>, Expert <dbl>, DateChecked <dttm>,
#   TS <lgl>
```
...
# A tibble: 408 x 3
 ...
 5 Salmo trutta       Medium     "Europe and Asia:  Atlantic, North, White and …
...
# A tibble: 19,479 x 9
 ...
 1       57 Salinator s… Salina… <NA>      Amphibo… Pulmo… Gastr… Mollu… Animal…
 2       58 Tasmaphena … Tasmap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 3       59 Tasmaphena … Tasmap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 4       60 Torresiropa… Torres… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 5       61 Victaphanta… Victap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 6       62 Victaphanta… Victap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 7       63 Victaphanta… Victap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 8       64 Victaphanta… Victap… <NA>      Rhytidi… Pulmo… Gastr… Mollu… Animal…
 9       65 Anoglypta l… Anogly… <NA>      Caryodi… Pulmo… Gastr… Mollu… Animal…
10       66 Brazieresta… Brazie… <NA>      Caryodi… Pulmo… Gastr… Mollu… Animal…
...
#   Vulnerability <dbl>, Length <dbl>, LTypeMaxM <chr>, LengthFemale <dbl>,
#   LTypeMaxF <chr>, MaxLengthRef <dbl>, CommonLength <dbl>, LTypeComM <chr>,
#   CommonLengthF <dbl>, LTypeComF <chr>, CommonLengthRef <dbl>, Weight <dbl>,
#   WeightFemale <dbl>, MaxWeightRef <dbl>, Pic <lgl>, PictureFemale <lgl>,
#   LarvaPic <lgl>, EggPic <lgl>, ImportanceRef <dbl>, Importance <chr>,
...
#   MHooksLines <dbl>, MOther <dbl>, UsedforAquaculture <chr>, LifeCycle <chr>,
#   AquacultureRef <dbl>, UsedasBait <chr>, BaitRef <dbl>, Aquarium <chr>,
#   AquariumFishII <chr>, AquariumRef <dbl>, GameFish <dbl>, GameRef <lgl>,
#   Dangerous <chr>, DangerousRef <dbl>, Electrogenic <chr>, ElectroRef <dbl>,
#   Complete <lgl>, ASFA <lgl>, GoogleImage <dbl>, Emblematic <dbl>,
#   Entered <dbl>, DateEntered <dttm>, Modified <dbl>, DateModified <dttm>,
#   Expert <dbl>, DateChecked <dttm>, Synopsis <lgl>, DateSynopsis <lgl>,
#   Flag <lgl>, Comments <chr>, VancouverAquarium <dbl>, Profile <lgl>,
