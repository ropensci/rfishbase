...
``` {r Figure2, fig.height=4, fig.width=6, fig.cap='Scatterplot maximum age with maximum length observed in each species. Color indicates marine or freshwater species.', dependson="libraries"}
...
``` {r Figure3, fig.height=3, fig.width=3, fig.cap='Distribution of maximum age for reef-associated and non-reef associated fish', dependson="libraries"}
...
``` {r Figure4, fig.height=3, fig.width=6, fig.cap='Correcting for phylogeny, maximum size is not correlated with maximum depth observed in  labrids', dependson="libraries"}
