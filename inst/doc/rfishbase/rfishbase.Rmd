...
which shows a significant correlation between maximum age and standard length (P = `r format.pval(2*pt(abs(coef(corr.model)[,'t value']["age"]), corr.model$df, lower.tail=F))`). 
